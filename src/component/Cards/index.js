        ...
        <>
            <div className="main-wrapper">
                ...
                <div className="movie-card flex-items">
                    ...
                    <div className="card">
                        <a href="#">
                            <img src={massiveTalent} height={400} width={300} />
                        </a>
                        <div class="title-wrapper">
                            <a href="#">
                    ...
                    <div className="card">
                        <a href="#">
                            <img src={memory} height={400} width={300} />
                        </a>
                        <div class="title-wrapper">
                            <a href="#">
                    ...
                    <div className="card">
                        <a href="#">
                            <img src={doctorStrange} height={400} width={300} />
                        </a>
                        <div class="title-wrapper">
                            <a href="#">
                        ...
                        <div class="card-meta">
                            <div class="badge badge-outline">1.5K</div>
                            <div className=" flex-items flex-end">
                                ...
                                <div className="flex-items">
                                    ...
                                    <p className="text-white" datetime="PT128M">135 min</p>
                                </div>
